...
import { copyData, DataSplitter } from "./DataSplitter";
import { OperationKind } from "./downloadPlanBuilder";
export function executeTasks(differentialDownloader, tasks, out, oldFileFd, reject) {
    const w = (taskOffset) => {
...
export function _executeTasks(differentialDownloader, options, out, resolve, reject) {
    let ranges = "bytes=";
    let partCount = 0;
...
export function checkIsRangesSupported(response, reject) {
